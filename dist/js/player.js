    ...
    var Player = function () {
        ...
        _createClass(Player, [{
            ...
            value: function controls() {
                ...
                return {
                    // 播放按钮
                    play: ce('div', { class: 'play-btn control-btn' }, [self.btns.play = ce('i', { class: 'picon icon-play', onClick: function onClick() {
                    ...
                    // 音量控制
                    voice: ce('div', { class: 'voice-control' }, [ce('div', { class: 'mute-btn control-btn' }, [self.btns.voice = ce('i', { class: 'picon icon-voice',
                    ...
                    // 全屏
                    fullscreen: ce('div', { class: 'zoomin-btn control-btn' }, [self.btns.fullscreen = ce('i', { class: 'picon icon-zoomin',
                        onClick: function onClick(ev) {
